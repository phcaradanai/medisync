...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/adm-chura3inter/medisync/services/core/internal/gen/medisync/audit/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AuditServiceName = "medisync.audit.v1.AuditService"
)
...
const (
	...
	// ListAuditLogs RPC.
	AuditServiceListAuditLogsProcedure = "/medisync.audit.v1.AuditService/ListAuditLogs"
)

// AuditServiceClient is a client for the medisync.audit.v1.AuditService service.
...
// NewAuditServiceClient constructs a client for the medisync.audit.v1.AuditService service. By
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	...
	auditServiceMethods := v1.File_medisync_audit_v1_audit_proto.Services().ByName("AuditService").Methods()
...
// ListAuditLogs calls medisync.audit.v1.AuditService.ListAuditLogs.
...
// AuditServiceHandler is an implementation of the medisync.audit.v1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/medisync.audit.v1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) ListAuditLogs(context.Context, *connect.Request[v1.ListAuditLogsRequest]) (*connect.Response[v1.ListAuditLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("medisync.audit.v1.AuditService.ListAuditLogs is not implemented"))
}
