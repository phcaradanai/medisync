...
#
# Usage:
#   DATABASE_URL="postgres://medisync:medisync@localhost:5432/medisync?sslmode=disable" ./scripts/test/smoke_demo_seed.sh
#
# The script checks:
...
DB="${DATABASE_URL:-postgres://medisync:medisync@localhost:5432/medisync?sslmode=disable}"
